...
//,--------------------+--------------------+--------------------+--------------------+--------------------+--------------------.                                             ,--------------------+--------------------+--------------------+--------------------+--------------------+--------------------.
            KC_ESC,                     KC_B,                KC_L,                KC_D,                KC_C,                KC_V,                                                              KC_J,                KC_Y,                KC_O,                KC_U,            KC_COMMA,             KC_BSPC,
//|--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|                                             |--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|
        LT(1, KC_TAB),                  KC_N,                KC_R,                KC_T,                KC_S,                KC_G,                                                              KC_P,                KC_H,                KC_A,                KC_E,                KC_I,     LT(4, KC_SLASH),
//|--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|                                             |--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|
            SC_LSPO,                    KC_X,                KC_Q,                KC_M,                KC_W,                KC_Z,                KC_X,                                         KC_K,                KC_F,            KC_QUOTE,             KC_SCLN,              KC_DOT,             SC_RSPC,
//`--------------------+--------------------+--------------------+--------------------+--------------------+--------------------+--------------------.   ,--------------------+--------------------+--------------------+--------------------+--------------------+--------------------+--------------------'
                                                                                            LCTL_T(KC_BTN2),     LALT_T(KC_BTN1),     LT(2, KC_ENTER),            LT(3, KC_SPACE),  RGUI_T(KC_PSCR),       MEH_T(KC_F24)
//                                                                                    `--------------------+--------------------+--------------------'   `--------------------+--------------------+--------------------'
